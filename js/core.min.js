 ...
 * @version      v2.0.0
 * @description  Allows you to use multiple toggles to switch class on the target,
 *               itself and other toggles linked to the same target.
 */

function initMultitoggle( options ) {
  // Toggle Prototype
  function Toggle( options ) {
    if( !options.node ) throw new Error( 'Toggle node is required' );
  ...
  Toggle.prototype.checkScope = function ( node ) {
  ...
  Toggle.prototype.checkIsolate = function ( node ) {
